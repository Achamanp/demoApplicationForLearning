...
public class JwtService {
    ...
    private final String SECRET = "!@#$FDGSDFGSGSGSGSHSHSHSSHGFFDSGSFGSSGHSDFSDFSFSFSFSDFSFSFSF";
    ...
    private Claims extractAllClaims(String token) {
        return Jwts.parserBuilder()
                ...
                .setAllowedClockSkewSeconds(900000000) // Allow 60 seconds of clock skew
                .build()
